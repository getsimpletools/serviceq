...
class Client
{
    ...
    protected static $_lastFunctionType = "consumer";
    ...
    {
        self::$_lastFunctionType = "service";
    ...
    {
        self::$_lastFunctionType = 'consumer';
    ...
    public static function lastFunctionType()
    {
        return self::$_lastFunctionType;
    }
